...
public interface IClientHandler {
	...
	/**
	 * Called directly by wolftail when game section changes from WANDERING to
	 * PLAYING.
	 * 
	...
	/**
	 * Called directly by wolftail when game section changes from PLAYING to
	 * WANDERING.
	 */
	void handleLeave();

	/**
	 * @return the current playing player type
	 */
	@Nonnull
	static UniversalPlayerType currentPlaying() {
		return ((ExtCoreMinecraft) Minecraft.getMinecraft()).wolftail_currentContext().playType();
	}
}
