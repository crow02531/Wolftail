...
public final class ContentOrder {
	...
	public ContentOrder(@Nonnull DimensionType target, int chunkX, int chunkZ) {
	...
	public boolean equals(Object o) {
		...
		if(o == null || o.getClass() != ContentOrder.class) return false;
		
		ContentOrder other = (ContentOrder) o;
